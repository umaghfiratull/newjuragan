...
<body>
    ...
    <!-- booking section start -->
        ...
        <div class="booking">
            ...
            <h1 class="heading-title">formulir register</h1>

            <form action="regis_form.php" method="post" class="book-form">
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <span>password :</span>
                        <input type="text" placeholder="enter your password" name="sandi">
                    </div>
