        ...
        <section class="container forms">
            ...
            <div class="form login">
                ...
                <div class="headerlogin">
                    ...
                    <div class="form-link">
                        <span>Belum Punya Akun? <a href="#" class="link signup-link">Daftar Sekarang</a></span>
                    </div>
                </div>
            ...
            <div class="form signup">
                <div class="form-content">
                <div class="logojuragan">
                    <img src="assets/imgs/Juragan.png" alt="Logo Juragan" class="logojuragan">
                </div>
                    <div class="headersignup">
                    <header>Pendaftaran Akun Admin</header>
                    </div>
                    <form method="POST">
                        <div class="field input-field">
